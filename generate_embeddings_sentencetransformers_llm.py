"""
Sentence-Transformers LLM Embeddings Generation Script
=====================================================

This script generates embeddings for LLM labels using sentence-transformers.
Saves embeddings to an /embeddings directory for reuse in semantic similarity analysis.

Usage:
    uv run python generate_embeddings_sentencetransformers_llm.py
"""
...
class SentenceTransformersLLMEmbeddingsGenerator:
    def __init__(self, data_path: str, model: str = "all-mpnet-base-v2", output_dir: str = "embeddings"):
        """
        Initialize the embeddings generator for LLM labels using sentence-transformers.
        ...
        # Must match the prompts used in human embeddings for consistency
        self.prompts = {
    ...
    def generate_llm_embeddings(self):
        ...
        """
        print("=" * 60)
        print("GENERATING LLM LABEL EMBEDDINGS WITH SENTENCE-TRANSFORMERS")
        print("=" * 60)
    ...
    def save_embeddings(self):
        ...
        embeddings_path = os.path.join(self.output_dir, "sentencetransformers_llm_embeddings.pkl")
        with open(embeddings_path, 'wb') as f:
            pickle.dump(embeddings_data, f)
        print(f"LLM embeddings saved to: {embeddings_path}")
        
        # Save metadata as JSON for easy inspection
        metadata_path = os.path.join(self.output_dir, "sentencetransformers_llm_embeddings_metadata.json")
    ...
    def run_generation(self):
        ...
        """
        print("Starting Sentence-Transformers LLM Embeddings Generation")
        print("=" * 60)
        ...
        print("\nSentence-Transformers LLM embeddings generation completed successfully!")
...
def main():
    ...
    print("Sentence-Transformers LLM Embeddings Generation")
    print("=" * 60)
    ...
    generator = SentenceTransformersLLMEmbeddingsGenerator(data_path, model)
